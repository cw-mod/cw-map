        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-6 pb-6 text-xs leading-relaxed text-gray-600">
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-4">
              ...
              <li>
                Чтобы найти путь, выберите «Откуда» и «Куда». Самый короткий
                маршрут посчитается сам.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-4">
              ...
              <li>
                ...
                он ведёт. Можно найти локацию по имени или создать новую.
                Галочка «Двусторонний» добавляет обратный переход.
              </li>
              <li>
                В списке «Другое» — выход в себя, лагерь, лазалки, плавательные,
                туннели и запрещённый проход. Для них не появляется новая
                карточка.
              </li>
              <li>
